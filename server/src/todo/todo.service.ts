...
export class TodoService {
  ...
  async newTodo(dueDate: Date, title: string, description: string, isCompleted: boolean) {
    try {
  ...
  async updateTodoById(id: string, dueDate: Date, title: string, description: string, isCompleted: boolean) {
    try {
      const todo = await this.TodoModel.findById(id);
